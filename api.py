...
session = api.model("Session", {"*": fields.Wildcard(fields.String)})
...
class Analysis(Resource):
    ...
    def post(self, username: str, project_index: int):
        ...
        for i in range(len(names)):
            ...
            audio_urls[names[i]] = (
                f"https://insightflow-test.s3.us-east-2.amazonaws.com/{urls[i]}{extension}"
            )
...
class AnalysisSpecific(Resource):
    ...
    def post(self, project_name):
        ...
        #     target=mvp.go,
        #     args=[questions, audio_urls, project_name])
        # analyses[project_name] = task
        # task.start()
    ...
    def get(self, project_name):
        ...
        #           "either the server restarted or the analysis doesn't exist"}
