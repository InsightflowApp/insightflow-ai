...
reduce_template = (
  ...
  ' - Theme 2: <second most common response to the question> (<n/total>)\n'
  '   - <title C>: <one quote from interview C>\n'
  '   - <...same thing for all interviews who answered with the theme>\n'
  ' - Theme 3: <third most common response to the question> (<n/total>)\n'
  ...
  'unique theme you see, and at least 3. The same quote can be used to '
