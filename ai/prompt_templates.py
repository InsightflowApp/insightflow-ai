...
map_template = (
  ...
  ' - <timestamp>: "<relevant quote 1>"\n'
  ' - <timestamp>: "<relevant quote 2>"\n'
  ' - <timestamp>: "<relevant quote 3>"\n'
...
reduce_template = (
  ...
  '   - <title A> (<timestamp start> -> <timestamp end>): <consecutive quote or conversation from interview A>\n'
  '   - <title B> (<timestamp start> -> <timestamp end>): <consecutive quote from interview B>\n'
  ...
  '   - <title C> (<timestamp start> -> <timestamp end>): <one quote from interview C>\n'
  ...
  '   - <title D> (<timestamp start> -> <timestamp end>): <one quote from interview D>\n'
  '   - <...same thing for ALL interview responses matching this theme>\n'
  ' * <describe this theme in 1 sentence>'
  ' - <Theme...etc.>\n'
